  ...
  try {
    ...
    if (ENABLE_GUI) {
      ...
      const httpServer = app.listen(port, () => {
        ...
        try {
          // Check if file exists; if not, do not listen (to avoid watch errors)
          if (fs.existsSync(TASKS_FILE_PATH)) {
            fs.watch(TASKS_FILE_PATH, (eventType, filename) => {
              if (
                ...
                // Slightly delay sending to prevent multiple triggers in a short time (e.g., editor saving)
      ...
      // Set process termination event handler (ensure watcher is removed)
